...
utiliza un bucle para sumar todas las duraciones solo de los álbumes de rock y luego imprime el total de estas duraciones por consola. 
*/
...
let duracionTotal = 0;
for (const albun of albums) {
    if (albun.genre == "Rock"){
        duracionTotal += albun.duration 
    }
    
};

console.log("La duración total es: " + duracionTotal);